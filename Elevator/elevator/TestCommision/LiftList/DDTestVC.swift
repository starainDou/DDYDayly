...
class DDTestVC: UIViewController {
    ...
    private lazy var notInsVC: DDTestSubVC = DDTestSubVC().then {
        $0.tagIndex = 0
        $0.sensorJson = sensorJson
    }
    
    private lazy var notComVC: DDTestSubVC = DDTestSubVC().then {
        $0.tagIndex = 4
        $0.sensorJson = sensorJson
    }
    
    private lazy var comVC: DDTestSubVC = DDTestSubVC().then {
        $0.tagIndex = 5
        $0.sensorJson = sensorJson
    }
    
    var currentVC: DDTestSubVC?
