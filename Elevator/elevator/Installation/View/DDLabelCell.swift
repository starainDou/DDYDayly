...
class DDLabelCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        contentView.addSubviews(flootLabel, tagLabel)
    ...
    public func loadData(item: String, isSelected: Bool) {
        flootLabel.text = item
        tagLabel.text = item
        flootLabel.textColor = isSelected ? UIColor(hex: "#FFFFFF") : UIColor(hex: "#333333")
